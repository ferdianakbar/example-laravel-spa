...
class ArticleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Article::create([
            ...
            'description' => 'Seas grow with courage at the coal-black fort charles! Mash up the chickpeas with chopped black pepper, baking powder,
        ...
        Article::create([
            ...
            'description' => 'Senior, extraterrestrial kahlesses accelerative examine a crazy, reliable pathway.
        ...
        Article::create([
            'title' => 'a-falsis-exsul-festus-tata',
            'description' => 'Parasites harvest with adventure at the final universe! The core is a distant kahless.
